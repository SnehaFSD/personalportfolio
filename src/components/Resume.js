  ...
  return (
    <section id = "resume" className='flex flex-col md:flex-row bg-secondary px-5 py-10'>
      <div className='md:w-1/2 py-5 flex justify-center md:justify-end'>
        <img className = "h-[400px] w-300 mx-auto " src = {MyResume} alt = "MyResume" />
      </div>
      <div className='w-full md:w-1/2 flex justify-left'>
      <div className='md:flex flex flex-col py-5 justify-center text-white px-4'>
        <h1 className='text-4xl border-b-4 border-white mb-5 w-[135px] font-bold'>Resume </h1>
